...
public class arrayAdapter1 extends BaseAdapter {
    ...
    public arrayAdapter1(Context context, ArrayList<Sch_DB> data){
        mcontext=context;
        this.data=data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            convertView= LayoutInflater.from(mcontext).inflate(R.layout.rownlp,parent,false);
        }
        Sch_DB tempData=(Sch_DB) getItem(position);
        TextView topic=(TextView)convertView.findViewById(R.id.topicTxt);
        TextView date=(TextView)convertView.findViewById(R.id.topicTxt2);
        ...
        date.setText(f1.format(tempData.getStart()));
